...
namespace P4Travia.Activities
{
    ...
    public class LocationActivity : Activity
    {
        ...
        //Switch buttons + managing device location
        private void SetSWitchButtons()
        {
            ...
            locationSwitch.CheckedChange += (s, e) =>
            {
                ...
                if (isChecked == true)
                {
                    try
                    {
                        //Should be fixed, goes to main when swtiches are toggled
            ...
            //Handling of radius does nothing
        ...
        public void SetSeekbar()
        {
            ...
            double r; //Needed for sortActivityProximity
