...
namespace P4Travia
{
    ...
    class LocationHandler
    {
        ...
        {
            //Uses Geolocation to find device latitude and longitude, gives this information til location obj
            try
            {
        ...
        {
            //Takes latitude and longitude coordinates and translates them to a place/adress, uses geocoding
            try
            {
                var lat = lc.Latitude;
